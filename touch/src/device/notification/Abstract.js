 ...
 * @private
 */
Ext.define('Ext.WmsDroid.notification.Abstract', {
    /**
     ...
     * Please not that you should not use more than 2 buttons, as they may not be displayed correct on all WmsDroids.
     *
    ...
    show: function(config) {
        if (!config.message) {
            throw('[Ext.WmsDroid.Notification#show] You passed no message');
        }
