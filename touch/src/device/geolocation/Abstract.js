 ...
 * @private
 */
Ext.define('Ext.WmsDroid.geolocation.Abstract', {
    config: {
        /**
        ...
        /**
         * @cfg {Number} frequency The default frequency to get the current position when using {@link Ext.WmsDroid.Geolocation#watchPosition}.
         */
        frequency: 10000,
    ...
    /**
     * Attempts to get the current position of this WmsDroid.
     *
     ...
     *     });
     *
     * *Note:* If you want to watch the current position, you could use {@link Ext.WmsDroid.Geolocation#watchPosition} instead.
     *
     * @param {Object} config An object which contains the following config options:
     *
     * @param {Function} config.success
     * The function to call when the location of the current WmsDroid has been received.
     *
     ...
     * True to enable allow accuracy detection of the location of the current WmsDroid. If you do not specify a value, it will
     * default to {@link #allowHighAccuracy}.
     */
    getCurrentPosition: function(config) {
        var defaultConfig = Ext.WmsDroid.geolocation.Abstract.prototype.config;
