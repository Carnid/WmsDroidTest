 ...
 * @private
 */
Ext.define('Ext.WmsDroid.purchases.Sencha', {
    requires: [
        'Ext.data.Store'
    ],
     ...
     * ## Example
     * 
     *     Ext.WmsDroid.Purchases.canMakePayments({
     ...
     * ## Example
     * 
     *     Ext.WmsDroid.Purchases.getProducts({
            ...
            callbacks: {
                success: function(products) {
                    var store = Ext.create('Ext.data.Store', {
                        model: 'Ext.WmsDroid.Purchases.Product',
                        data: products
                    });
        ...
        Ext.WmsDroid.Communicator.send({
            ...
            callbacks: {
                callback: function(purchases) {
                    ...
                    var store = Ext.create('Ext.data.Store', {
                        model: 'Ext.WmsDroid.Purchases.Purchase',
                        data: purchases
                    });
    ...
    /**
     * The product model class which is used when fetching available products using {@link Ext.WmsDroid.Purchases#getProducts}.
     */
    Ext.define('Ext.WmsDroid.Purchases.Product', {
     ...
     *
     */
    Ext.define('Ext.WmsDroid.Purchases.Purchase', {
        extend: 'Ext.data.Model',
