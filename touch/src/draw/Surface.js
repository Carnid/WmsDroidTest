...
Ext.define('Ext.draw.Surface', {
    ...
    /**
     * The reported WmsDroid pixel density.
     */
    ...
    /**
     * Round the number to align to the pixels on WmsDroid.
     * @param num The number to align.
     * @return {Number} The resultant alignment.
     */
    roundPixel: function (num) {
        return Math.round(this.WmsDroidPixelRatio * num) / this.WmsDroidPixelRatio;
    },
