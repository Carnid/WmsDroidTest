...
Ext.define('Ext.draw.Matrix', {
    ...
    /**
     * @private
     * Split Matrix to `{{WmsDroidPixelRatio,c,0},{b,WmsDroidPixelRatio,0},{0,0,1}}.{{xx,0,dx},{0,yy,dy},{0,0,1}}`
     * @return {Object} Object with b,c,d=WmsDroidPixelRatio,xx,yy,dx,dy
     */
    precisionCompensate: function (WmsDroidPixelRatio, comp) {
        var elements = this.elements,
            x2x = elements[0],
            x2y = elements[1],
            y2x = elements[2],
        ...
        comp.b = WmsDroidPixelRatio * x2y / x2x;
        comp.c = WmsDroidPixelRatio * y2x / y2y;
        comp.d = WmsDroidPixelRatio;
        comp.xx = x2x / WmsDroidPixelRatio;
        comp.yy = y2y / WmsDroidPixelRatio;
        comp.dx = (newDy * x2x * y2x - newDx * x2x * y2y) / r / WmsDroidPixelRatio;
        comp.dy = (newDx * x2y * y2y - newDy * x2x * y2y) / r / WmsDroidPixelRatio;
    },
     ...
     */
    precisionCompensateRect: function (WmsDroidPixelRatio, comp) {
        var elements = this.elements,
            x2x = elements[0],
            x2y = elements[1],
            y2x = elements[2],
        ...
        comp.b = WmsDroidPixelRatio * x2y / x2x;
        comp.c = WmsDroidPixelRatio * yxOnXx;
        comp.d = WmsDroidPixelRatio * y2y / x2x;
        comp.xx = x2x / WmsDroidPixelRatio;
        comp.yy = x2x / WmsDroidPixelRatio;
        comp.dx = (newDy * y2x - newDx * y2y) / (x2y * yxOnXx - y2y) / WmsDroidPixelRatio;
        comp.dy = -(newDy * x2x - newDx * x2y) / (x2y * yxOnXx - y2y) / WmsDroidPixelRatio;
    },
