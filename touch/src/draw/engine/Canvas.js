...
Ext.define('Ext.draw.engine.Canvas', {
    ...
    createCanvas: function () {
        ...
        this.WmsDroidPixelRatio /= (Ext.os.is.WindowsPhone) ? window.innerWidth / window.screen.width : backingStoreRatio;
    ...
    enablePrecisionCompensation: function (ctx) {
        ...
        var override = {
            ...
            updatePrecisionCompensate: function () {
                matrix.precisionCompensate(surface.WmsDroidPixelRatio, comp);
                xx = comp.xx;
                yy = comp.yy;
                dx = comp.dx;
                dy = comp.dy;
                return originalCtx.setTransform.call(this, surface.WmsDroidPixelRatio, comp.b, comp.c, comp.d, 0, 0);
            },
            ...
            updatePrecisionCompensateRect: function () {
                matrix.precisionCompensateRect(surface.WmsDroidPixelRatio, comp);
                xx = comp.xx;
                yy = comp.yy;
                dx = comp.dx;
                dy = comp.dy;
    ...
    updateRegion: function (region) {
        ...
        var me = this,
            ...
            WmsDroidPixelRatio = me.WmsDroidPixelRatio,
            w = r - l,
            h = b - t,
            splitThreshold = Math.round(me.splitThreshold / WmsDroidPixelRatio),
        ...
        for (i = 0, offsetX = 0; i < splits; i++, offsetX += splitThreshold) {
            ...
            if (h * WmsDroidPixelRatio !== dom.height) {
                dom.height = h * WmsDroidPixelRatio;
                dom.style.height = h + 'px';
            }
            leftWidth = Math.min(splitThreshold, w - offsetX);
            if (leftWidth * WmsDroidPixelRatio !== dom.width) {
                dom.width = leftWidth * WmsDroidPixelRatio;
    ...
    clearTransform: function () {
        ...
        for (i = 0; i < activeCanvases; i++) {
            ...
            ctx.scale(me.WmsDroidPixelRatio, me.WmsDroidPixelRatio);
    ...
    renderSprite: function (sprite) {
        ...
        for (i = 0, offsetX = 0; i < me.activeCanvases; i++, offsetX += me.splitThreshold / me.WmsDroidPixelRatio) {
            ctx = me.contexts[i];
            width = Math.min(region[2] - offsetX, me.splitThreshold / me.WmsDroidPixelRatio);
            left = offsetX;
            right = left + width;
