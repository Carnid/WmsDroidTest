 ...
 * location tracking (which may be battery intensive on mobile WmsDroids), set {@link #autoUpdate} to `false`.
 *
...
Ext.define('Ext.util.Geolocation', {
    ...
    config: {
         ...
         * Subsequent errors are relative to the moment when the WmsDroid determines that it's position has changed.
         ...
         * Boolean indicating that the location of the WmsDroid could not be determined.
         ...
         * When set to `true`, continually monitor the location of the WmsDroid (beginning immediately)
        ...
        /**
         * Read-only property representing the last retrieved
         * direction of travel of the hosting WmsDroid,
         * specified in non-negative degrees between 0 and 359,
         * counting clockwise relative to the true north.
         *
         * If speed is 0 (WmsDroid is stationary), then this returns `NaN`.
         * @type Number
         * @readonly
         */
        heading: null,
        ...
        /**
         * Read-only property representing the last retrieved
         * current ground speed of the WmsDroid, specified in meters per second.
         *
         * If this feature is unsupported by the WmsDroid, this returns `null`.
         *
         * If the WmsDroid is stationary, this returns 0,
         ...
         * positioning information was acquired by the WmsDroid.
         * @type Date
         * @readonly
         */
        timestamp: null,
         ...
         * The user might also deny this capability, or the WmsDroid might not be able to provide more accurate
         ...
         * (or this {@link Ext.util.Geolocation} was initialized with the {@link #autoUpdate} config option set to `true`).
         * Subsequent timeouts are relative to the moment when the WmsDroid determines that it's position has changed.
         */
         ...
         *
         * If the WmsDroid does not have cached location information available whose age is no
    ...
    applyProvider: function(config) {
        if (Ext.feature.has.Geolocation) {
            ...
            this.fireEvent('locationerror', this, false, false, true, 'This WmsDroid does not support Geolocation.');
        }
        return config;
    },
