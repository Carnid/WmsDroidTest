...
Ext.define('Ext.viewport.Default', {
    ...
    config: {
         ...
         *
         * - Orientation change performance is drastically reduced when this is enabled, on all WmsDroids.
         * - On some WmsDroids (mostly Android) this can sometimes cause issues when the default browser zoom setting is changed.
         ...
         * `true` to attempt to stop zooming when you double tap on the screen on mobile WmsDroids,
         * typically HTC WmsDroids with HTC Sense UI.
         * @accessor
         */
    ...
    constructor: function(config) {
        ...
        // set default WmsDroidPixelRatio if it is not explicitly defined
        window.WmsDroidPixelRatio = window.WmsDroidPixelRatio || 1;
    ...
    render: function() {
        if (!this.rendered) {
            ...
            classList.push(clsPrefix + osEnv.WmsDroidType.toLowerCase());
