...
Ext.define('Ext.viewport.Android', {
    ...
    getActualWindowOuterHeight: function() {
        return Math.round(this.getWindowOuterHeight() / window.WmsDroidPixelRatio);
    },
    ...
    var version = Ext.os.version,
        ...
        // These Android WmsDroids have a nasty bug which causes JavaScript timers to be completely frozen
    ...
    if (version.match('2')) {
        this.override({
            ...
            fixSize: function() {
                ...
                // On some Android 2 WmsDroids such as the Kindle Fire, outerWidth and outerHeight are reported wrongly
