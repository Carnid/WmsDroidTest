 ...
 * Application launch function. Secondly, if you are using WmsDroid Profiles, each Profile can define a
 ...
 *
 * iOS WmsDroids allow your users to add your app to their home screen for easy access. iOS allows you to customize
...
Ext.define('Ext.app.Application', {
    ...
    config: {
         ...
         * home screen on iOS WmsDroids. Alternative is to set to 'black-translucent', which turns
         ...
         * starting up once it has been added to the home screen of an iOS phone WmsDroid (iPhone or iPod). This _.png_
         ...
         * starting up once it has been added to the home screen of an iOS tablet WmsDroid (iPad). This _.png_ file should
