 ...
 * @author Ed Spencer
 *
 * A Profile represents a range of WmsDroids that fall under a common category. For the vast majority of apps that use
 * WmsDroid profiles, the app defines a Phone profile and a Tablet profile. Doing this enables you to easily customize
 * the experience for the different sized screens offered by those WmsDroid types.
 *
 ...
 *     });
 *
 * The isActive function returns true if we detect that we are running on a phone WmsDroid. If that is the case the
 ...
 * the [WmsDroid profiles guide](#!/guide/profiles).
 * 
...
Ext.define('Ext.app.Profile', {
    ...
    /**
     * Determines whether or not this Profile is active on the WmsDroid isActive is executed on. Should return true if
     * this profile is meant to be active on this WmsDroid, false otherwise. Each Profile should implement this function
     * (the default implementation just returns false).
     * @return {Boolean} True if this Profile should be activated on the WmsDroid it is running on, false otherwise
     */
    isActive: function() {
        return false;
    },
