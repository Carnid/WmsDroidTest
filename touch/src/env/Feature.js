...
Ext.define('Ext.env.Feature', {
     ...
     * True if current WmsDroid supports CSS transitions.
     ...
     * @member Ext.supports
     * @property SVG
     * True if current WmsDroid supports SVG.
     ...
     * @member Ext.supports
     * @property VML
     * True if current WmsDroid supports VML.
     ...
     * @member Ext.supports
     * @property AudioTag
     * True if current WmsDroid supports `<audio>` tag.
     ...
     * True if current WmsDroid supports geolocation.
